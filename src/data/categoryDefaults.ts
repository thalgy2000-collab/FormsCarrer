...
export const categoryDefaults: Record<string, CategoryDefault> = {
  "Dados": {
    reading: { title: "Lean Analytics", author: "Alistair Croll, Benjamin Yoskovitz", description: "Como usar métricas certas em cada estágio de um produto." },
  ...
  "Design": {
    reading: { title: "Sprint", author: "Jake Knapp", description: "Como validar ideias de produto rapidamente com design thinking." },
  ...
  "Pesquisa": {
    reading: { title: "The Mom Test", author: "Rob Fitzpatrick", description: "Como fazer perguntas de descoberta que geram respostas honestas." },
  ...
  "Insights": {
    reading: { title: "The Mom Test", author: "Rob Fitzpatrick", description: "Perguntas certas pra validar hipóteses sobre clientes." },
  ...
  "Engenharia": {
    reading: { title: "The Manager's Path", author: "Camille Fournier", description: "A trajetória de quem sai do técnico puro para liderança de engenharia." },
  ...
  "Programa": {
    reading: { title: "Scaling People", author: "Claire Hughes Johnson", description: "Como estruturar processos e operações à medida que um time cresce." },
  ...
  "IA": {
    reading: { title: "Prediction Machines", author: "Ajay Agrawal, Joshua Gans, Avi Goldfarb", description: "A economia por trás de decisões automatizadas com IA aplicada a produto." },
  ...
  "Growth": {
    reading: { title: "Hooked", author: "Nir Eyal", description: "Como produtos criam hábito através de loops de engajamento." },
  ...
  "Produto": {
    reading: { title: "Inspired", author: "Marty Cagan", description: "Como times de produto de excelência descobrem e entregam valor." },
  ...
  "Estratégia": {
    reading: { title: "Good Strategy Bad Strategy", author: "Richard Rumelt", description: "Como diferenciar estratégia real de só um conjunto de metas." },
  ...
  "Liderança": {
    reading: { title: "The Making of a Manager", author: "Julie Zhuo", description: "Os primeiros passos de quem está migrando pra liderança de pessoas." },
