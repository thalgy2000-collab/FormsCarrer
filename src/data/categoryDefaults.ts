...
export const categoryDefaults: Record<string, CategoryDefault> = {
  "Dados": {
    reading: [
      { title: "Lean Analytics", author: "Alistair Croll, Benjamin Yoskovitz", description: "Como usar métricas certas em cada estágio de um produto.", link: "https://www.google.com/search?q=Lean+Analytics+Alistair+Croll,+Benjamin+Yoskovitz+livro" },
      { title: "Product Analytics: O guia completo", author: "PM3", description: "Artigo completo sobre análise de produto e métricas.", link: "https://www.cursospm3.com.br/blog/product-analytics/" }
    ],
  ...
  "Design": {
    reading: [
      { title: "Sprint", author: "Jake Knapp", description: "Como validar ideias de produto rapidamente com design thinking.", link: "https://www.google.com/search?q=Sprint+Jake+Knapp+livro" },
      { title: "Product Design: o que é e como atuar?", author: "Tera", description: "Visão detalhada sobre a área de design de produto.", link: "https://somostera.com/blog/product-design" }
    ],
  ...
  "Pesquisa": {
    reading: [
      { title: "The Mom Test", author: "Rob Fitzpatrick", description: "Como fazer perguntas de descoberta que geram respostas honestas.", link: "https://www.google.com/search?q=The+Mom+Test+Rob+Fitzpatrick+livro" },
      { title: "Como fazer Product Discovery", author: "PM3", description: "Guia prático para descobrir valor e reduzir riscos.", link: "https://www.cursospm3.com.br/blog/product-discovery/" }
    ],
  ...
  "Insights": {
    reading: [
      { title: "The Mom Test", author: "Rob Fitzpatrick", description: "Perguntas certas pra validar hipóteses sobre clientes.", link: "https://www.google.com/search?q=The+Mom+Test+Rob+Fitzpatrick+livro" },
      { title: "Customer Centric: como aplicar", author: "Mulheres de Produto", description: "Artigo sobre como colocar o usuário no centro da estratégia.", link: "https://medium.com/mulheres-de-produto" }
    ],
    recommendedTrack: dadosTrack,
  ...
  "Engenharia": {
    reading: [
      { title: "The Manager's Path", author: "Camille Fournier", description: "A trajetória de quem sai do técnico puro para liderança de engenharia.", link: "https://www.google.com/search?q=The+Manager%27s+Path+Camille+Fournier+livro" },
      { title: "O papel do Tech Lead", author: "Product Gurus", description: "Discussão sobre responsabilidades e transição para liderança técnica.", link: "https://productgurus.com.br/" }
    ],
  ...
  "Programa": {
    reading: [
      { title: "Scaling People", author: "Claire Hughes Johnson", description: "Como estruturar processos e operações à medida que um time cresce.", link: "https://www.google.com/search?q=Scaling+People+Claire+Hughes+Johnson+livro" },
      { title: "Product Operations: o que faz", author: "PM3", description: "O papel de Product Ops na escalabilidade dos times.", link: "https://www.cursospm3.com.br/blog/product-ops/" }
    ],
    recommendedTrack: produtoTrack,
  ...
  "Operações": {
    reading: [
      { title: "Scaling People", author: "Claire Hughes Johnson", description: "Como estruturar processos e operações à medida que um time cresce.", link: "https://www.google.com/search?q=Scaling+People+Claire+Hughes+Johnson+livro" },
      { title: "O guia de Product Ops", author: "Tera", description: "Como estruturar operações de produto na prática.", link: "https://somostera.com/blog/product-ops" }
    ],
    recommendedTrack: produtoTrack,
  ...
  "IA": {
    reading: [
      { title: "Prediction Machines", author: "Ajay Agrawal, Joshua Gans, Avi Goldfarb", description: "A economia por trás de decisões automatizadas com IA aplicada a produto.", link: "https://www.google.com/search?q=Prediction+Machines+Ajay+Agrawal,+Joshua+Gans,+Avi+Goldfarb+livro" },
      { title: "O papel do AI Product Manager", author: "PM3", description: "Como atuar na intersecção entre Produto e Inteligência Artificial.", link: "https://www.cursospm3.com.br/blog/ai-product-manager/" }
    ],
    recommendedTrack: produtoTrack,
  ...
  "Growth": {
    reading: [
      { title: "Hooked", author: "Nir Eyal", description: "Como produtos criam hábito através de loops de engajamento.", link: "https://www.google.com/search?q=Hooked+Nir+Eyal+livro" },
      { title: "Product-Led Growth", author: "Tera", description: "Guia completo sobre a estratégia de crescimento liderada pelo produto.", link: "https://somostera.com/blog/plg-product-led-growth" }
    ],
  ...
  "Produto": {
    reading: [
      { title: "Inspired", author: "Marty Cagan", description: "Como times de produto de excelência descobrem e entregam valor.", link: "https://www.google.com/search?q=Inspired+Marty+Cagan+livro" },
      { title: "O que é Product Management", author: "PM3", description: "Fundamentos e pilares da gestão de produtos.", link: "https://www.cursospm3.com.br/blog/o-que-e-product-management/" }
    ],
    recommendedTrack: produtoTrack,
  ...
  "Estratégia": {
    reading: [
      { title: "Good Strategy Bad Strategy", author: "Richard Rumelt", description: "Como diferenciar estratégia real de só um conjunto de metas.", link: "https://www.google.com/search?q=Good+Strategy+Bad+Strategy+Richard+Rumelt+livro" },
      { title: "Product Strategy: como criar", author: "Product Gurus", description: "Como desenhar uma estratégia de produto vencedora.", link: "https://productgurus.com.br/" }
    ],
    recommendedTrack: produtoTrack,
  ...
  "Liderança": {
    reading: [
      { title: "The Making of a Manager", author: "Julie Zhuo", description: "Os primeiros passos de quem está migrando pra liderança de pessoas.", link: "https://www.google.com/search?q=The+Making+of+a+Manager+Julie+Zhuo+livro" },
      { title: "Liderança em Produto", author: "Mulheres de Produto", description: "Dicas e desafios na transição para a liderança de equipes de produto.", link: "https://medium.com/mulheres-de-produto" }
    ],
    recommendedTrack: produtoTrack,
